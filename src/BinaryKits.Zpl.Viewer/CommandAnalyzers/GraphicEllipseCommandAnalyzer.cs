...
public class GraphicEllipseCommandAnalyzer : ZplCommandAnalyzerBase
{
    public GraphicEllipseCommandAnalyzer(VirtualPrinter virtualPrinter) : base("^GE", virtualPrinter)
    {
    }
    ...
    public override ZplElementBase Analyze(string zplCommand)
    {
        ...
        return new ZplGraphicEllipse(x, y, width, height, borderThickness, lineColor);
    }
}
