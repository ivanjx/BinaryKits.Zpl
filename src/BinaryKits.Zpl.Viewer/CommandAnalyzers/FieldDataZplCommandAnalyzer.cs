        ...
        public override ZplElementBase Analyze(string zplCommand, VirtualPrinter virtualPrinter, IPrinterStorage printerStorage)
        {
            ...
            if (virtualPrinter.NextElementFieldData != null)
            {
                ...
                else if (virtualPrinter.NextElementFieldData is QrCodeBarcodeFieldData qrCode)
                {
                    ...
                    return new ZplQrCode(parsedText, x, y, qrCode.Model, qrCode.MagnificationFactor, errorCorrection, qrCode.MaskValue, FieldOrientation.Normal, hexadecimalIndicator, bottomToTop, useDefaultPosition, qrCode.VerticalQuietZone);
                }
                ...
                else if (virtualPrinter.NextElementFieldData is CodeMsiBarcodeFieldData msi)
                {
                    return new ZplBarcodeMsi(text, x, y, msi.Height, moduleWidth, wideBarToNarrowBarWidthRatio, msi.FieldOrientation, msi.CheckDigitSelection, hexadecimalIndicator, msi.PrintInterpretationLine, msi.PrintInterpretationLineAboveCode, msi.PrintInterpretationLineWithCheckDigit, bottomToTop);
                }
                else if (virtualPrinter.NextElementFieldData is CodeLogmarsBarcodeFieldData logmars)
                {
                    return new ZplBarcodeLogmars(text, x, y, logmars.Height, moduleWidth, wideBarToNarrowBarWidthRatio, logmars.FieldOrientation, logmars.PrintInterpretationLineAboveCode, hexadecimalIndicator, bottomToTop);
                }
            }
