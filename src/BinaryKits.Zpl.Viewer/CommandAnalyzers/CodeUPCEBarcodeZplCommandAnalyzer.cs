...
public class CodeUPCEBarcodeZplCommandAnalyzer : ZplCommandAnalyzerBase
{
    public CodeUPCEBarcodeZplCommandAnalyzer(VirtualPrinter virtualPrinter) : base("^B9", virtualPrinter)
    {
    }
    ...
    public override ZplElementBase Analyze(string zplCommand)
    {
        ...
        this.VirtualPrinter.SetNextElementFieldData(new CodeUPCEBarcodeFieldData
        {
